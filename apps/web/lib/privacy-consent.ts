...
export const COOKIE_CATEGORIES: CookieCategory[] = [
	{
		...
		description:
			"Required for the application to function properly. These cookies enable core functionality such as session management and security.",
		required: true,
	...
	},
	{
		...
		name: "Analytics",
		description:
			"Help us improve the application by collecting anonymous usage data. This helps us understand how users interact with the service.",
		required: false,
	...
	},
	{
		...
		name: "Preferences",
		description:
			"Remember your settings and preferences, such as theme, language, and display options.",
		required: false,
	...
	},
	{
		...
		name: "Marketing",
		description:
			"Track effectiveness of our marketing campaigns and personalize content based on your interests.",
		required: false,
...
export function grantConsent(categories: ConsentCategory[]): void {
	...
	const preferences: ConsentPreferences = {
		...
		preferences:
			categories.includes("preferences") || categories.includes("necessary"),
...
export function updateConsent(
	...
	const preferences: ConsentPreferences = {
		necessary: true,
		analytics:
			category === "analytics" ? granted : (previous?.analytics ?? false),
		marketing:
			category === "marketing" ? granted : (previous?.marketing ?? false),
		preferences:
			category === "preferences" ? granted : (previous?.preferences ?? true),
		version: CONSENT_VERSION,
		grantedAt: previous?.grantedAt || now,
		updatedAt: now,
	};
...
export function useConsent() {
	...
	const update = useCallback(
		(category: Exclude<ConsentCategory, "necessary">, granted: boolean) => {
...
export function getUserRegion(): "eu" | "us" | "other" {
	...
	const usTimezones = ["America/", "Pacific/Honolulu"];
