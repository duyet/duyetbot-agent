...
const PROMPTS = [
  { id: 'p1', name: 'Chat Agent', version: 'v1.0.2', updated: '2h ago', content: 'You are a helpful AI assistant...' },
  { id: 'p2', name: 'Code Expert', version: 'v2.1', updated: '1d ago', content: 'You are an expert software engineer...' },
  { id: 'p3', name: 'Twitter Bot', version: 'v0.9', updated: '5d ago', content: 'You create engaging tweets...' },
];
      ...
      <div className="flex h-full border-t border-border">
                 ...
                 >
                   <div className="space-y-1">
                      ...
                      <div className="text-[10px] opacity-70 flex items-center gap-1.5">
                         <span className="bg-primary/10 text-primary px-1 rounded text-[9px]">{prompt.version}</span>
        ...
        <div className="flex-1 flex flex-col bg-background min-h-[500px]">
           ...
           <div className="h-10 border-b border-border flex items-center justify-between px-4 bg-muted/5">
              ...
              <div className="flex items-center gap-2">
                  <Button variant="ghost" size="sm" className="h-7 text-xs">Variables</Button>
        ...
        <div className="w-72 border-l border-border bg-muted/5 hidden xl:flex flex-col">
           <div className="p-4 border-b border-border">
              <h3 className="text-xs font-semibold uppercase tracking-wider text-muted-foreground">Variables</h3>
           </div>
           <div className="p-4 space-y-4">
               ...
               <Card className="bg-background border-border/50 shadow-sm">
                  <CardHeader className="p-3 pb-1">
                     <CardTitle className="text-xs font-mono text-primary">{'{rag_knowledge}'}</CardTitle>
                  </CardHeader>
                  <CardContent className="p-3 pt-1 text-xs text-muted-foreground">
