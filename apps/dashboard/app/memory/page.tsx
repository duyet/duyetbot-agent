...
import { ArrowRight, Brain, Database, Search, Settings, Sparkles } from 'lucide-react';
...
const MOCK_RESULTS = [
  ...
  {
    id: 'm2',
    content: 'Project "Duyetbot" uses Next.js 16 and Cloudflare Workers.',
    similarity: 0.88,
  ...
  {
    id: 'm3',
    content: 'The user is focused on upgrading the dashboard UI to X.AI style.',
    similarity: 0.82,
    source: 'task_log',
    date: '10 mins ago',
  },
        ...
        <section className="relative">
          ...
          <div className="flex flex-col items-center space-y-4 text-center py-8">
            ...
            <p className="text-muted-foreground max-w-md">
              Enter a query to perform a semantic search against the vector index and see what
        ...
        <div className="grid gap-4 md:grid-cols-3">
          ...
          <Card className="bg-card/50">
            <CardContent className="p-6 flex items-center justify-between">
              ...
              <div className="h-8 w-8 rounded bg-green-500/10 flex items-center justify-center text-green-500 font-bold text-xs">
                Active
              </div>
            </CardContent>
          </Card>
        ...
        <div className="space-y-4">
          ...
          <div className="grid gap-3">
            {MOCK_RESULTS.map((result) => (
              <Card
                key={result.id}
                className="group hover:border-primary/50 transition-colors cursor-default"
              >
                <CardContent className="p-4 flex gap-4">
                  {/* Score */}
                  <div className="flex flex-col items-center justify-center w-16 shrink-0 border-r border-border pr-4">
                    <span
                      className={`text-lg font-bold ${result.similarity > 0.9 ? 'text-green-500' : 'text-yellow-500'}`}
                    >
                  ...
                  <div className="flex-1 space-y-1">
                    ...
                    <div className="flex items-center gap-3 pt-2">
                      <Badge
                        variant="secondary"
                        className="text-[10px] h-5 rounded-sm px-1.5 font-normal text-muted-foreground"
                      >
                        {result.source}
                      </Badge>
  ...
  return (
    <div className="h-8 w-8 relative flex items-center justify-center">
      <svg
        ...
        viewBox="0 0 36 36"
        role="img"
        aria-label="Index Health Status"
      >
