 ...
 * ```
 */
export function calculateEffectiveEnergyCost(
  task: ScheduledTask,
 ...
 * ```
 */
export function regenerateEnergy(budget: EnergyBudget, now: number): EnergyBudget {
 ...
 * ```
 */
export function getEnergyPercentage(budget: EnergyBudget): number {
 ...
 * ```
 */
export function getEnergyBreakdown(budget: EnergyBudget): {
  tokenPercent: number;
