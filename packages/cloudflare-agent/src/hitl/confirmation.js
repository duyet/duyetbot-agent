 ...
 */
export function hasToolConfirmation(message) {
 ...
 */
export function parseConfirmationResponse(message) {
 ...
 */
export function determineRiskLevel(toolName, args) {
 ...
 */
export function requiresConfirmation(toolName, args, threshold = 'high') {
...
export function createToolConfirmation(
  ...
  toolArgs,
  description,
  expiryMs = DEFAULT_CONFIRMATION_EXPIRY_MS
) {
  const now = Date.now();
 ...
 */
export function formatConfirmationRequest(confirmation) {
  const riskEmoji =
 ...
 */
export function formatMultipleConfirmations(confirmations) {
 ...
 */
export function isConfirmationValid(confirmation) {
  return confirmation.status === 'pending' && confirmation.expiresAt > Date.now();
}
/**
 * Filter out expired confirmations
 */
export function filterExpiredConfirmations(confirmations) {
  const now = Date.now();
