 ...
 * ```
 */
export function formatSessionKey(sessionId: SessionId): string {
 ...
 * @example
 * ```typescript
 * const sessionId = parseSessionKey('telegram:123456789:-1001234567890');
 * // { platform: 'telegram', userId: '123456789', chatId: '-1001234567890' }
 * ```
 */
export function parseSessionKey(sessionKey: string): SessionId | null {
