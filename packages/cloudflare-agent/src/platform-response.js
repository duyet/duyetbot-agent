 ...
 */
export async function sendPlatformResponse(env, target, text, debugContext) {
 ...
 */
async function sendTelegramResponse(env, chatId, messageId, text, botToken, parseMode = 'HTML') {
 ...
 * @param debugContext - Optional debug context for admin users
 */
async function sendGitHubResponse(env, target, text, debugContext) {
 ...
 */
function formatGitHubDebugFooter(debugContext) {
