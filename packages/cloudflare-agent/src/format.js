 ...
 * ```
 */
export function formatToolProgress(executions, config = {}) {
 ...
 */
export function formatCompleteResponse(executions, finalContent, config = {}) {
 ...
 */
export function getRandomThinkingMessage(extended = false) {
 ...
 * @param extended - Use extended messages for longer waits
 */
export function formatThinkingMessage(format = 'markdown', extended = false) {
 ...
 */
export function formatErrorMessage(error, format = 'markdown') {
  if (format === 'markdown') {
    return `❌ **Error**: ${error}`;
  }
  return `❌ Error: ${error}`;
 ...
 * ```
 */
export function createThinkingRotator(config = {}) {
 ...
 */
export function getDefaultThinkingMessages() {
 ...
 */
export function getExtendedThinkingMessages() {
 ...
 * ```
 */
export function formatHistoryAsXML(history) {
  if (history.length === 0) {
    return '';
  }
 ...
 * ```
 */
export function formatWithEmbeddedHistory(messages, systemPrompt, userMessage, quotedContext) {
