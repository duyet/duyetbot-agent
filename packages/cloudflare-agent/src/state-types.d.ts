...
export declare const MAX_TRACES = 100;
/** Default stuck threshold in milliseconds (60 seconds) */
export declare const DEFAULT_STUCK_THRESHOLD_MS = 60000;
/** Watchdog interval in seconds */
export declare const WATCHDOG_INTERVAL_SECONDS = 30;
/**
 * Create initial State DO state
 */
export declare function createInitialStateDOState(): StateDOState;
/**
 * Create a new session state
 */
export declare function createSessionState(params: RegisterBatchParams): SessionState;
