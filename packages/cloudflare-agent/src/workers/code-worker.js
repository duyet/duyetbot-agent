 ...
 */
export function detectCodeTaskType(task) {
 ...
 */
function buildCodePrompt(step, dependencyContext, defaultLanguage) {
 ...
 */
function parseCodeResponse(content, expectedOutput) {
 ...
 * ```
 */
export function createCodeWorker(config) {
  const baseConfig = {
