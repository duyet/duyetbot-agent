 ...
 */
export function parseMention(text, username) {
 ...
 */
export function hasMention(text, username) {
 ...
 */
export function extractAllMentions(text, username) {
 ...
 */
export function isCommand(text, commands = DEFAULT_COMMANDS) {
 ...
 */
export function extractTask(text, username) {
